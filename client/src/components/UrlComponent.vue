<template>
    <div class="space-y-2">
        ...
        <div class="flex space-x-2">
            ...
            <button :disabled="!url.length" type="button" class="text-white bg-green-700 font-medium rounded-lg text-xs px-3 py-2 hover:bg-green-800 focus:ring-4 focus:ring-green-300 focus:outline-none">Test</button>
        </div>
