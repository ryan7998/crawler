      ...
      <div class="relative w-full max-w-6xl transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all">
        ...
        <div class="p-6">
          ...
          <div v-if="proxyStats && proxyStats.summary">
            <!-- Summary (compact, matches site style) -->
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
              <div class="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-base font-semibold text-gray-900 tabular-nums">{{ formatNumber(proxyStats.summary.totalProxyRequests) }}</p>
                </div>
              </div>
              <div class="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
                ...
                <div class="min-w-0">
                  <p class="text-xs font-medium text-gray-500">Unique Proxies</p>
                  <p class="text-base font-semibold text-gray-900 tabular-nums">{{ formatNumber(proxyStats.summary.uniqueProxiesUsed) }}</p>
                </div>
              </div>
              <div class="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-purple-100">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-base font-semibold text-gray-900 tabular-nums">{{ formatPercentage(proxyStats.summary.averageSuccessRate) }}</p>
                </div>
              </div>
            </div>
