<template>
    <div class="flex space-x-2 ml-3">
        ...
        <div v-if="showRemoveButton" class="flex items-end">
            <button 
                v-if="showRemoveButton"
                type="button" 
                class="rounded-md text-xs text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium px-2.5 py-2"
